    ...
    public void handle(WhatsappSession session, String phone, String message, String buttonId){
        switch(session.getState()){
            ...
            case REGISTER_CONFIRM:
                ...
                whatsappService.sendMessage(phone, "Account created successfully");
